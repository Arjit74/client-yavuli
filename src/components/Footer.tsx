                ...
                <div className="grid grid-cols-2 lg:grid-cols-3 gap-12 md:gap-24">
                    ...
                    <div className="space-y-4 col-span-2 lg:col-span-1">
                        ...
                        <div className="space-y-2 text-sm text-slate-500 font-medium">
                            ...
                            <a href="mailto:admin@yavuli.app" className="flex items-center gap-2 max-w-[200px] break-all hover:text-primary transition-colors"><Mail className="h-3 w-3" /> admin@yavuli.app</a>
